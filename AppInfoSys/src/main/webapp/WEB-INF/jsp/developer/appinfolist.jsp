<%@page import="cn.appinfo.util.PageUtil"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
	if (request.getAttribute("appInfoPage") == null){
  		response.sendRedirect("../devUser/appInfoList");
  	} else {
  		PageUtil appInfoPage = (PageUtil)request.getAttribute("appInfoPage");
...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="${pageContext.request.contextPath }/devUser/appInfoList">
	...
	<div class="x_panel">
		<div class="x_content">
			...
			<div id="datatable-responsive_wrapper"
				...
				<div class="row">
					<div class="col-sm-12">
					<a href="${pageContext.request.contextPath}/devUser/toAppInfoAdd" class="btn btn-success btn-sm">新增APP基础信息</a>
						<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed"
							...
							<tbody>
								<c:forEach var="appInfo" items="${appInfoPage.appList }" varStatus="status">
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="dataTables_info" id="datatable-responsive_info"
							role="status" aria-live="polite">共${appInfoPage.count }条记录
							${appInfoPage.index }/${appInfoPage.total }页</div>
					</div>
					<div class="col-sm-7">
						<div class="dataTables_paginate paging_simple_numbers"
							id="datatable-responsive_paginate">
							<ul class="pagination">
								<c:if test="${appInfoPage.index > 1}">
									...
									<li class="paginate_button "><a
										href="javascript:page_nav(document.forms[0],${appInfoPage.index-1});"
										aria-controls="datatable-responsive" data-dt-idx="1"
										tabindex="0">上一页</a>
									</li>
								</c:if>
								<c:if test="${appInfoPage.index < appInfoPage.total }">
									<li class="paginate_button "><a
										href="javascript:page_nav(document.forms[0],${appInfoPage.index+1 });"
										aria-controls="datatable-responsive" data-dt-idx="1"
										tabindex="0">下一页</a>
									...
									<li class="paginate_button next"><a
										href="javascript:page_nav(document.forms[0],${appInfoPage.total });"
