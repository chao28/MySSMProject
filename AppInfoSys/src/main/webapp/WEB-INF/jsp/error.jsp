...
<html lang="en">
  ...
  <body class="nav-md" onload="logout()">
        ...
        <div class="col-md-12">
          <div class="col-middle">
            <div class="text-center">
              <h1 class="error-number">发生问题</h1>
              <h1>系统发生故障，攻城狮正在努力修复中！</h1>
              <h2>若有问题请联系我们：010-8859-111111</h2>
              <h2>官网：<a href="http://www.kengni.com">http://www.kengni.com</a></h2>
