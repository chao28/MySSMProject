...
<%
	if (request.getAttribute("page") == null){
  		response.sendRedirect("bill.html?method=query");
  	} else {
  		PageUtil pUtil = (PageUtil)request.getAttribute("page");
		request.setAttribute("page", pUtil);
  	}
 %>
<div class="right">
       <div class="location">
       ...
       <div class="search">
       <form name="formList" method="get" action="${pageContext.request.contextPath }/bill.html?method=query">
			...
			<select name="queryIsPayment">
			 ...
			 <a href="${pageContext.request.contextPath }/toAddBill.html">添加订单</a>
		</form>
       </div>
       <!--账单表格 样式和供应商公用-->
